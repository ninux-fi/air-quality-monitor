...
bool Sds011::query_data(float *pm25, float *pm10)
{
  bool ok;
...
bool Sds011::query_data_auto(float *pm25, float *pm10, int n)
{
  float pm25_table[n];
  float pm10_table[n];
  int ok;
...
void Sds011::_filter_data(int n, float *pm25_table, float *pm10_table, float *pm25, float *pm10)
{
  float pm25_min, pm25_max, pm10_min, pm10_max, pm25_sum, pm10_sum;
